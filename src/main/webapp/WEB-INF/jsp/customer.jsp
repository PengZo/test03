...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-inline" action="${pageContext.request.contextPath }/customer/list.action" method="get"
                    ...
                    <input type="hidden" name="rows" value="${page.size}">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default" id="app-3">
                    ...
                    <div class="col-md-12 text-right" id="example">
...
<script type="text/javascript">
    function editCustomer(id) {
        $.ajax({
            ...
            data: {"id": id},//参数的名称 id=1  如果是JSON对象  jquery会自动的将json对象转成类似于 id=1&abc=2&efg=3 这种字符串
...
<script type='text/javascript'>
    var options = {
        ...
        onPageClicked: function(e,originalEvent,type,page){
            ...
            $.ajax({
                type: "POST",
                url: "<%=basePath%>customer/lista.action",
